...
class Column extends Component {
  render() {
    ...
    if (addWidgetComponent) {
      addWidgetComponentToUse = createElement(addWidgetComponent, {	text: addWidgetButtonText, onClick:	() => {onAdd(layout, rowIndex, columnIndex);} });
    } else {
      addWidgetComponentToUse = <AddWidget text={addWidgetButtonText} onClick={() => {onAdd(layout, rowIndex, columnIndex);}}/>;
    }
