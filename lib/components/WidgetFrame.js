  ...
  hover(props, monitor, component) {
    ...
    if (curItem.columnIndex === columnIndex) {
      const newLayout = sortWidget(layout, {
        ...
        }, curItem.widgetName, props.title, props);
...
class WidgetFrame extends Component {
  render() {
    ...
    let selected = null;
    const compProps = { children, editable, title, onRemove: this.remove, rowIndex, columnIndex, widgetIndex };
    if (frameComponent) {
...
WidgetFrame.propTypes = {
   ...
   * Title of the widget.
   */
  title: PropTypes.oneOfType(PropTypes.bool, PropTypes.element, PropTypes.func, PropTypes.number, PropTypes.object, PropTypes.string, PropTypes.symbol, PropTypes),
